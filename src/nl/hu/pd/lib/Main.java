...
public class Main {
    ...
    public static void main(String [] args) throws SQLException {
        ...
        // i.p.v adao te testen, test ik rdao die adao bevat;
        // adao wordt automatisch aangeroepen in rdao behalve adao.findAll();
        System.out.println("[TEST 1] : TEST ALLE REIZIGERS(rdao.findAll())");
        int count = 0;
        ...
        Adres adres = new Adres(6,"9999AB","5B","Katerstraat","Tiel", 6);
